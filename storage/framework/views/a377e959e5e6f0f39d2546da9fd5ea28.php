<nav style="background-color: #2e3d36; padding: 15px; border-radius: 8px; margin-bottom: 25px; display: flex; gap: 30px; justify-content: center; border-bottom: 3px solid #afb867; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
    <a href="<?php echo e(route('login')); ?>" style="color: #afb867; font-weight: bold; text-decoration: none; border-bottom: 2px solid #afb867; padding-bottom: 4px;">LOGIN</a>
...
<center>
    <div class="login-card">
        ...
        <form action="<?php echo e(route('login.autenticar')); ?>" method="POST" style="display: block; width: 100%;">
            <?php echo csrf_field(); ?>

            <div style="margin-bottom: 20px;">
                <label class="login-label">Correo Electrónico:</label>
                <input type="email" name="email" class="login-input" placeholder="ejemplo@correo.com" required value="<?php echo e(old('email')); ?>">
            </div>
...
</center><?php /**PATH C:\xampp\htdocs\proyectoFinal-main\catedra2-laravel\resources\views/login.blade.php ENDPATH**/ ?>